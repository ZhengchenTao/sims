...
<body>
	<div class="row" style="width:100%">
		<div class="edit col-md-4 col-md-offset-4">
			<s:form action="student/doEdit" method="post">
				...
				<div class="form-group">
					<label for="classes_id">班级</label> <select class="form-control"
						...
						<s:iterator value="#list" var="l">
							<s:if test="#stu.classes_id==#l.id">
								<option value="${l.id }" selected="selected">${l.grade}</option>
							</s:if>
							<s:else>
				...
				<div class="form-group">
					<label for="age">年龄</label> <input type="text" class="form-control"
						id="age" name="student.age" value="${stu.age }">
				</div>
